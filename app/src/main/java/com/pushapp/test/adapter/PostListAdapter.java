package com.pushapp.test.adapter;
...
import com.pushapp.test.HomeActivity;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        try{
            ...
            if(article.getHeaderImage() != null && article.getHeaderImage().size() > 0){
                CacheManager.getInstance(getContext()).loadBitmap(article.getHeaderImage().get("url"), imageView, this);
