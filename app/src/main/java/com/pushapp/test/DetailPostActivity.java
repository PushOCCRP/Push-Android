...
import com.pushapp.test.fragment.DetailPost;
...
public class DetailPostActivity extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.pushapp.test.R.layout.activity_detail_post);
        ...
        mPager = (ViewPager)findViewById(com.pushapp.test.R.id.pager);
        mPager.setAdapter(mAdapter);
        mPager.setOffscreenPageLimit(2);
        int pageCount = mPager.getAdapter().getCount();
        mIndicator = (CirclePageIndicator) findViewById(com.pushapp.test.R.id.indicator);
    ...
    private void initActionBar() {
        mToolbar = (Toolbar) findViewById(com.pushapp.test.R.id.toolbar);
        mToolbar.setTitleTextColor(getResources().getColor(R.color.primary_dark_material_dark));
        setSupportActionBar(mToolbar);
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);
        getSupportActionBar().setTitle(null);
        getSupportActionBar().setDisplayUseLogoEnabled(true);
        getSupportActionBar().setLogo(com.pushapp.test.R.mipmap.logo);
    }

    @Override
    public boolean onCreateOptionsMenu(Menu menu) {
        // Inflate the menu; this adds items to the action bar if it is present.
        getMenuInflater().inflate(com.pushapp.test.R.menu.menu_detail_post, menu);
        return true;
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if(id== com.pushapp.test.R.id.action_share){
            doShare();
