...
import com.push.risemd.fragment.DetailPost;
...
public class DetailPostActivity extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.push.risemd.R.layout.activity_detail_post);
        ...
        mPager = (ViewPager)findViewById(com.push.risemd.R.id.pager);
        mPager.setAdapter(mAdapter);
        mPager.setOffscreenPageLimit(2);
        int pageCount = mPager.getAdapter().getCount();
        mIndicator = (CirclePageIndicator) findViewById(com.push.risemd.R.id.indicator);
    ...
    private void initActionBar() {
        ...
        getSupportActionBar().setLogo(com.push.risemd.R.mipmap.logo);
    }

    @Override
    public boolean onCreateOptionsMenu(Menu menu) {
        // Inflate the menu; this adds items to the action bar if it is present.
        getMenuInflater().inflate(com.push.risemd.R.menu.menu_detail_post, menu);
        return true;
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if(id== com.push.risemd.R.id.action_share){
            doShare();
