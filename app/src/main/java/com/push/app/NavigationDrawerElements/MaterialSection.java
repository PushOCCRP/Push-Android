package com.push.app.NavigationDrawerElements;
...
import com.push.app.layouts.MaterialRippleLayout;
...
//                    view = LayoutInflater.from(ctx).inflate(R.layout.layout_material_section_ripple, null);
                    break;
                case ICON_24DP:
                    view = LayoutInflater.from(ctx).inflate(R.layout.nav_drawer_row, null);
