...
import com.push.cins.fragment.DetailPost;
...
public class DetailPostActivity extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.push.cins.R.layout.activity_detail_post);
        ...
        mPager = (ViewPager)findViewById(com.push.cins.R.id.pager);
        mPager.setAdapter(mAdapter);
        mPager.setOffscreenPageLimit(2);
        int pageCount = mPager.getAdapter().getCount();
        mIndicator = (CirclePageIndicator) findViewById(com.push.cins.R.id.indicator);
    ...
    private void initActionBar() {
        mToolbar = (Toolbar) findViewById(com.push.cins.R.id.toolbar);
        mToolbar.setTitleTextColor(getResources().getColor(R.color.primary_dark_material_dark));
        setSupportActionBar(mToolbar);
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);
        getSupportActionBar().setTitle(null);
        getSupportActionBar().setDisplayUseLogoEnabled(true);
        getSupportActionBar().setLogo(com.push.cins.R.mipmap.logo);
    }

    @Override
    public boolean onCreateOptionsMenu(Menu menu) {
        // Inflate the menu; this adds items to the action bar if it is present.
        getMenuInflater().inflate(com.push.cins.R.menu.menu_detail_post, menu);
        return true;
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if(id== com.push.cins.R.id.action_share){
            doShare();
